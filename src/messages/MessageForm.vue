    ...
    <div class="messageform">
      ...
      <form @submit.prevent="sendMessage">
        <div class="input-group mb-4">
          <input v-model.trim="message" name="message" id="message" style="border-radius: 5px;"
          placeholder="Type a message" class="form-control" mt-3 autofocus>


          <div class="input-group-append">
            <button @click="sendMessage" class="btn btn-primary ml-2 mr-2"
            style="border-radius: 5px;" type="button">&nbsp; Send &nbsp;</button>
          </div>

          <div class="input-group-append">
            <button @click="openFileModal" :disabled="uploadState == 'uploading'" class="btn btn-warning" style="border-radius: 5px;" type="button">Upload</button>
          </div>
        </div>
      </form>
